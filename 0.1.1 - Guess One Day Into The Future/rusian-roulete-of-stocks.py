...
# Loop Through The Data Until A Guess Is Within Margin Of Error Than Break
while True:
    ...
    model.fit(x_train, y_train, epochs=1,batch_size=32) # Epochs (25) - how many times models sees the data

    #-# Test Model On Existing Data #-#

    # Load Test Time And Data
    test_start = dt.datetime(2020,1,1)
    test_end = dt.datetime(2021,7,21)
    ...
    print("-----")
    if abs(prediction-todaydata) <= margin_of_error:
        print("Guess Within Margin Of Error")
        break
    else:
        print(prediction)
        print("Guess Not Within")
...
test_end = dt.datetime(2021,7,22)
test_data = web.DataReader(company, 'yahoo', test_start, test_end)
